<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addnewLinksModal" tabindex="-1" aria-labelledby="addnewLinksModalLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addnewLinksModalLabel">{{ __('translate.new') }}</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="links" class="form-control" placeholder="https://">@error('links') <span class="text-danger">{{ __('translate.error_link') }}
                                </span> @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                @error('description') <span class="text-danger">{{ __('translate.error_image') }}</span> @enderror
                            </div>
                        </div>
                    </div>
...
<!-- Update Links Modal -->
<div wire:ignore.self class="modal fade" id="updateLinksModal" tabindex="-1" aria-labelledby="updateLinksModalLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="updateLinksModalLabel">{{ __('translate.update') }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" wire:click="closeModal" aria-label="Close"><i class="fas fa-close text-secondary text-sm"></i></button>
            </div>
...
<!-- Delete Link Modal -->
<div wire:ignore.self class="modal fade" id="deleteLinksModal" tabindex="-1" aria-labelledby="deleteLinksModalLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
