    ...
    <body>
        ...
        <script>
            ...
            window.onload = function () {
                ...
                images = [
                    'landing_page/uploads/488X250-A.gif', 
                    'landing_page/uploads/488X250-B.gif', 
                    'landing_page/uploads/488X250-C.gif', 
                    'landing_page/uploads/488X250-D.gif',
                    'landing_page/uploads/488X250-E.gif'
                ]
                ...
                $.each(images, function(index, image) {
                    ...
                    $(".mySwiperMobile .swiper-wrapper").append(swiperWrapper);
